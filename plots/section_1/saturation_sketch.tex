...
\begin{tikzpicture}
    ...
    \begin{pgfonlayer}{background}
      ...
      \fill[ColourHl2,  opacity=0.175] (axis cs:0,-2) rectangle (axis cs:0.9,14);
      \fill[ColourBase,   opacity=0.175] (axis cs:0.9,-2) rectangle (axis cs:1.0,14);
      \fill[ColourHl1,   opacity=0.175] (axis cs:1.0,-2) rectangle (axis cs:1.1,14);
      \fill[ColourDark2, opacity=0.250] (axis cs:1.1,-2) rectangle (axis cs:2.9,14);
    \end{pgfonlayer}
